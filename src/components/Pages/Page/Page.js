...
class Page extends Component {
	...
	switchGradeHandler = (grade) =>{
		let gradeLevel=" "
		if(grade==1) 
			gradeLevel="Your Freshman Year is Over!"
		if(grade==2) 
			gradeLevel="Your Sophomore Year is Over!"
		if(grade==3) 
			gradeLevel="Your Junior Year is Over!"
		if(grade==4) 
			gradeLevel="Your Senior Year is Over!"
		this.setState({grade:gradeLevel})
						...
						{
							{
								...
								9: (
									<Aux>
										<Fade bottom>
											<Question>
												How about taking a part time job?
											</Question>
									...
									<Aux>
										<Fade bottom>
											...
											>
												...
												graduated, and your friends want
												to go out to eat at a fancy new
												restaurant. you know that you
												still have your monthly payment
												for student loans.
											</Question>
											<Fade bottom cascade>
												<h3>
									...
									<Aux>
										<Fade bottom>
											...
											>
												...
												first payment. you are charged a
												200 dollar late fee
											</h1>
											<Fade bottom>
												<Button1
									...
									<Aux>
										<Fade bottom>
											...
											>
												...
												friends said that the meal was
												not worth it, so you definitely
												lucked out.
											</h1>
											<Fade bottom>
												<Button1
